...
pkgname=arcolinux-gzr-system-config-git
_pkgname=arcolinux-gzr-system-config
...
pkgver=18.12
pkgrel=10
pkgdesc="Configuration files for Arco-GzR"
arch=('any')
url="https://github.com/Arcolinux-GzR/arcolinux-gzr-system-config"
license=('GPL3')
makedepends=('git')
depends=()
provides=("${pkgname}")
